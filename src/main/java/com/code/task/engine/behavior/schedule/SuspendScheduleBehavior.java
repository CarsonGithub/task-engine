...
@Component
public class SuspendScheduleBehavior implements ScheduleBehavior {

    @Override
    public String getPhase() {
        return Suspend_Schedule;
    }

    @SneakyThrows
    @Override
    public void doExecute(TaskContext taskContext) {
        taskContext.serviceProvider().schedule().suspend((IEventSchedule) taskContext.getSchedule());
    }
}
